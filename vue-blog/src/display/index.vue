                ...
                <div class="guanzhu-static" id="guanzhu">
                    <mochi-box shiba="random">
                        <el-card style="text-align: center">
                            ...
                            <p class="new-blog">Email: 2668304028@qq.com</p>
                            <p class="new-blog">QQ: 2668304028</p>
                        </el-card>
                    </mochi-box>
                </div>
            </div>
        ...
        <el-footer style="background: #545c64; height: 240px;margin-top:10px;">
            <el-row
                ...
                <el-col :span="9" style="text-align: center">
                    <p style="color: white;font-size: 15px;margin: 0;line-height: 28px">皮划艇</p>
                    <p class="new-blog">Nothing is true, Everything is permitted.</p>
                </el-col>
            </el-row>
            ...
            <el-row
                    ...
                    justify="center"
                    align="middle">
                <span>Copyright © 2019 pht Designed by pht</span>
            </el-row>
        </el-footer>
