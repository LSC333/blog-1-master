<template>
    <div>
        <el-card>
            <div slot="header">
                <h2 style="color: #ffd04b;display: inline-block;margin: 0">关于我们</h2>
            </div>
            <p style="font-size: 15px">皮划艇，一个又皮又划的团队。</p>
            ...
            <el-row>
                <el-col :span="2">
                    <a href="https://github.com/LSC333" target="_blank">
                        <svg
                ...
                <el-col :span="2">
                    <el-tooltip effect="dark" content="2668304028" placement="bottom">
        ...
        <el-card style="margin-top: 10px">
            <img src="../../assets/img/about.jpg" width="855" height="533">
        </el-card>
    </div>
